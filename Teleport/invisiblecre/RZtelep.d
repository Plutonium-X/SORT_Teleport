...
SAY @3
IF ~Global("RZAR0700","GLOBAL",1)~ THEN REPLY #20853 GOTO 3
IF ~Global("RZAR0400","GLOBAL",1)~ THEN REPLY #20935 GOTO 4
IF ~Global("RZAR0800","GLOBAL",1)~ THEN REPLY #26799 GOTO 5
IF ~Global("RZAR0300","GLOBAL",1)~ THEN REPLY #23726 GOTO 6
IF ~Global("RZAR0500","GLOBAL",1)~ THEN REPLY #26465 GOTO 7
IF ~Global("RZAR0900","GLOBAL",1)~ THEN REPLY #29743 GOTO 8
IF ~Global("RZAR1000","GLOBAL",1)~ THEN REPLY #29744 GOTO 9
IF ~Global("RZAR0020","GLOBAL",1)~ THEN REPLY #40271 GOTO 10
IF ~Global("RZAR1300","GLOBAL",1)~ THEN REPLY @4 GOTO 11
IF ~Global("RZAR1100","GLOBAL",1)~ THEN REPLY #2151 GOTO 12
IF ~Global("RZAR1404","GLOBAL",1)~ THEN REPLY #39972 GOTO 13
IF ~OR(10)
    ...
    Global("RZAR2600","GLOBAL",1)~ THEN REPLY @5 GOTO 1
...
IF ~~ THEN BEGIN 1
SAY @3
IF ~Global("RZAR1200","GLOBAL",1)~ THEN REPLY #2150 GOTO 14
IF ~Global("RZAR2000","GLOBAL",1)~ THEN REPLY #44980 GOTO 15
IF ~Global("RZAR1900","GLOBAL",1)~ THEN REPLY #44999 GOTO 16
IF ~Global("RZAR1600","GLOBAL",1)~ THEN REPLY #466 GOTO 17
IF ~Global("RZAR2300","GLOBAL",1)~ THEN REPLY @7 DO ~SetGlobal("RZTeleport","GLOBAL",97)~ EXIT
IF ~Global("RZAR2100","GLOBAL",1)~ THEN REPLY #61424 GOTO 18
...
IF ~OR(10)
    Global("RZAR2800","GLOBAL",1)
    Global("RZAR3000","GLOBAL",1)
    Global("RZAR6400","GLOBAL",1)
    Global("RZAR5202","GLOBAL",1)
    Global("RZAR5200","GLOBAL",1)
    Global("RZAR5203","GLOBAL",1)
    Global("RZAR6300","GLOBAL",1)
    Global("RZAR5500","GLOBAL",1)
    Global("RZAR6000","GLOBAL",1)
    Global("RZAR6100","GLOBAL",1)~ THEN REPLY @5 GOTO 2
...
IF ~~ THEN BEGIN 2
SAY @3
IF ~Global("RZAR2800","GLOBAL",1)~ THEN REPLY #61254 GOTO 19
IF ~Global("RZAR3000","GLOBAL",1)~ THEN REPLY #66122 GOTO 20
...
IF ~Global("RZAR5200","GLOBAL",1)~ THEN REPLY #70662 GOTO 21
...
IF ~Global("RZAR5500","GLOBAL",1)~ THEN REPLY #70659 GOTO 22
IF ~Global("RZAR6000","GLOBAL",1)~ THEN REPLY #71739 GOTO 23
IF ~Global("RZAR6100","GLOBAL",1)~ THEN REPLY #71738 GOTO 24
...
IF ~Global("RZAR0411","GLOBAL",1)~ THEN REPLY #48366 GOTO 4.1
...
IF ~Global("RZAR0305","GLOBAL",1)~ THEN REPLY #20989 GOTO 6.1
...
IF ~Global("RZAR0509","GLOBAL",1)~ THEN REPLY #33357 GOTO 7.1
...
IF ~Global("RZAR0701","GLOBAL",1)~ THEN REPLY #19674 GOTO 8.1
IF ~~ THEN REPLY @8 GOTO 0
IF ~~ THEN REPLY @6 DO ~SetGlobal("RZAllowTeleport","GLOBAL",0)
                        DestroySelf()~ EXIT
END
...
IF ~Global("RZAR0202","GLOBAL",1)~ THEN REPLY @21 GOTO 8.1.1
...
IF ~Global("RZAR1201","GLOBAL",1)~ THEN REPLY @32 GOTO 14.1
IF ~~ THEN REPLY @8 GOTO 1
IF ~~ THEN REPLY @6 DO ~SetGlobal("RZAllowTeleport","GLOBAL",0)
                        DestroySelf()~ EXIT
END
...
IF ~Global("RZAR2200","GLOBAL",1)~ THEN REPLY @40 GOTO 18.1
IF ~~ THEN REPLY @8 GOTO 1
IF ~~ THEN REPLY @6 DO ~SetGlobal("RZAllowTeleport","GLOBAL",0)
                        DestroySelf()~ EXIT
END
...
IF ~Global("RZAllowTeleport","GLOBAL",2)~ THEN BEGIN 25
SAY @52
IF ~~ THEN DO ~SetGlobal("RZAllowTeleport","GLOBAL",0)
               DestroySelf()~ EXIT
END

IF ~Global("RZAllowTeleport","GLOBAL",3)~ THEN BEGIN 26
SAY @53
IF ~~ THEN DO ~SetGlobal("RZAllowTeleport","GLOBAL",0)
               DestroySelf()~ EXIT
END
